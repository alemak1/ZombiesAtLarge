...
extension GameScene{
    ...
    func addBackgroundBaseColor(){
        
        guard let background = SKScene(fileNamed: self.currentGameLevel.getSKSceneFilename())?.childNode(withName: "background") as? SKSpriteNode else {
