...
class GameScene: BaseScene{
    ...
    func loadTestItems(){
        ...
        let collectibleSprite1 = CollectibleSprite(collectibleType: .Toaster)
        collectibleSprite1.position = CGPoint(x: 100.0, y: 0.0)
        collectibleSprite1.move(toParent: worldNode)
        
        let collectibleSprite2 = CollectibleSprite(collectibleType: .TestTubes)
        collectibleSprite2.position = CGPoint(x: 150.0, y: 0.0)
        collectibleSprite2.move(toParent: worldNode)
        
        let collectibleSprite3 = CollectibleSprite(collectibleType: .ComputerTowerGrey)
        collectibleSprite3.position = CGPoint(x: 100.0, y: 0.0)
        collectibleSprite3.move(toParent: worldNode)
        
    
        let collectibleSprite4 = CollectibleSprite(collectibleType: .Sander)
        collectibleSprite4.position = CGPoint(x: 150.0, y: 0.0)
        collectibleSprite4.move(toParent: worldNode)
        
        let collectibleSprite5 = CollectibleSprite(collectibleType: .Shovel)
        collectibleSprite5.position = CGPoint(x: 200, y: 0.0)
        collectibleSprite5.move(toParent: worldNode)
        
        let collectibleSprite6 = CollectibleSprite(collectibleType: .Scraper)
        collectibleSprite6.position = CGPoint(x: 250, y: 0.0)
        collectibleSprite6.move(toParent: worldNode)
        
        
        let collectibleSprite7 = CollectibleSprite(collectibleType: .ScreenMonitor)
        collectibleSprite7.position = CGPoint(x: 100.0, y: -100.0)
        collectibleSprite7.move(toParent: worldNode)
        
        let collectibleSprite8 = CollectibleSprite(collectibleType: .Stethoscope)
        collectibleSprite8.position = CGPoint(x: 150.0, y: -1000.0)
        collectibleSprite8.move(toParent: worldNode)
        
        let collectibleSprite9 = CollectibleSprite(collectibleType: .SocketWrench)
        collectibleSprite9.position = CGPoint(x: 100.0, y: -100.0)
        collectibleSprite9.move(toParent: worldNode)
        
        
        let collectibleSprite10 = CollectibleSprite(collectibleType: .Tack)
        collectibleSprite10.position = CGPoint(x: 150.0, y: -100.0)
        collectibleSprite10.move(toParent: worldNode)
        
        let collectibleSprite11 = CollectibleSprite(collectibleType: .RAMStick3)
        collectibleSprite11.position = CGPoint(x: 200, y: -100.0)
        collectibleSprite11.move(toParent: worldNode)
        
        let collectibleSprite12 = CollectibleSprite(collectibleType: .Tongs)
        collectibleSprite12.position = CGPoint(x: 250, y: 0.0)
        collectibleSprite12.move(toParent: worldNode)
    ...
    func loadControls(atPosition position: CGPoint){
        ...
        **/
        ...
        self.menuOptionsButton.position = CGPoint(x: position.x, y: position.y)
